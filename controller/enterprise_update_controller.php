<?php
	...
	$query->modifyEnterprise($name_enterprise,$address_enterprise,$city,$state,$country,$pc,$line_business,$name_contact,$phone_contact,$mail_contact,$job_title_contact);
